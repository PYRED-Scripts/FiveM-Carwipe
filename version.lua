PerformHttpRequest("https://api.github.com/repos/LucaNL/CarWipe-FiveM/releases/latest", function(err, text, headers)
	...
	if text then
		...
		print("  //\n  ||    "..GetCurrentResourceName().." is Created by "..info.author.login.."\n  ||")

		if ( newestVersion ~= nil ) then
			if newestVersion ~= currentVersion then
				print("  ||    Current version: ^1" .. currentVersion .. "^0")
				print("  ||    Latest version: ^2" .. newestVersion .."^0\n  ||")
				print("  ||    ^1An update is available for "..GetCurrentResourceName()..", visit https://github.com/LucaNL/CarWipe-FiveM to get the latest version.\n^0  \\\\")
